...
/// 1) Игрок взаимодействует с сцп используя определенный предмет, который работает на определенном СЦП
/// 2) Запускается дуафтер
/// 3) По его окочанию проигрывается звук
/// 4) С СЦП падает какой-то исследовательский материал
/// 5) Дальнейшие взаимодействия с этим СЦП уходят в КД, пока оно не пройдет любые взаимодействия с ним для получения материалов невозможны.
...
public sealed class ScpInteractSystem : EntitySystem
{
