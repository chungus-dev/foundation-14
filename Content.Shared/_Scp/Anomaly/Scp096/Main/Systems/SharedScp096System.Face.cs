...
public abstract partial class SharedScp096System
{
    ...
    private void OnFaceDamageChanged(Entity<Scp096FaceComponent> ent, ref DamageChangedEvent args)
    {
        ...
        if (_damageable.GetTotalDamage((ent.Owner, args.Damageable)) == aliveThreshold)
            HealFace(ent);
    }
    ...
    {
        if (TryComp<DamageableComponent>(face, out var damageable)
            && _damageable.GetTotalDamage((face.Owner, damageable)) != FixedPoint2.Zero)
