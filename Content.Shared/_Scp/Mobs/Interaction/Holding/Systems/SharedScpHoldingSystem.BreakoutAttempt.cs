...
public abstract partial class SharedScpHoldingSystem
{
    ...
    {
        var currentMovement = args.Entity.Comp.HeldMoveButtons & MoveButtons.AnyDirection;
        var previousMovement = args.OldMovement & MoveButtons.AnyDirection;
        var newlyPressed = currentMovement & ~previousMovement;

        return newlyPressed != MoveButtons.None;
    }
