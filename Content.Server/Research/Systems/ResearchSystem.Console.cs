...
public sealed partial class ResearchSystem
{
    ...
    private void OnRediscoverTechnology(EntityUid uid, ResearchConsoleComponent console, ConsoleRediscoverTechnologyMessage args)
    {
        var act = args.Actor;
    ...
    private void OnConsoleUnlock(EntityUid uid, ResearchConsoleComponent component, ConsoleUnlockTechnologyMessage args)
    {
        ...
        if (!_emag.CheckFlag(uid, EmagType.Interaction))
        {
            ...
            var message = Loc.GetString(
                ...
                ("amount", ResearchPointsHelper.PointsToString(ResearchPointsHelper.GetPoints(technologyPrototype), " ", PrototypeManager)),
    ...
    private void UpdateConsoleInterface(EntityUid uid, ResearchConsoleComponent? component = null, ResearchClientComponent? clientComponent = null)
    {
        ...
        var rediscoverCost = new Dictionary<ProtoId<ResearchPointPrototype>, int>();
