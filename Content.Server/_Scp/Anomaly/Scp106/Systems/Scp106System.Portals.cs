...
public sealed partial class Scp106System
{
    ...
    private void InitializePortals()
    {
        ...
        SubscribeLocalEvent<HumanoidProfileComponent, MobStateChangedEvent>(OnHumanMobStateChanged);
    }
    ...
    private void OnHumanMobStateChanged(Entity<HumanoidProfileComponent> ent, ref MobStateChangedEvent args)
    {
    ...
    private void StartScreech(EntityUid uid, bool playSound = true)
    {
    }
}
