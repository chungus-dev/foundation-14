...
public sealed partial class Scp049System
{
    ...
    private void MakeMinion(Entity<MobStateComponent> minionEntity, Entity<Scp049Component> scpEntity)
    {
        ...
        _zombie.ZombifyEntity(minionEntity);
        if (TryComp<ZombieComponent>(minionEntity, out var zombie))
        {
            zombie.EyeColor = zombieComponent.EyeColor;
            zombie.StatusIcon = zombieComponent.StatusIcon;
            Dirty(minionEntity, zombie);
        }
