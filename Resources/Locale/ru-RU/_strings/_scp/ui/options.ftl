...
ui-options-scp-local-player-shadow-outside-fov = Показывать свою тень за спиной
...
ui-options-field-of-view-blur-enabled-tooltip =
    ...
    Отключите для повышения производительности или если эффект мешает.
...
ui-options-scp-typing-sound-enabled = Звуки печати
ui-options-scp-typing-sound-enabled-tooltip =
    При включении печать символов создает особый звук

ui-options-scp-typing-chat-submit-sound-enabled = Звуки отправки сообщения в чате
ui-options-scp-typing-chat-submit-sound-enabled-tooltip =
    При включении отправка сообщений в игровом чате создает особый звук
