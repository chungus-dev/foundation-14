...
public sealed partial class PlayerListEntry : BoxContainer
{
    ...
    // Scp added start - selected ahelp rows use light background and dark content
    public void SetSelected(bool selected)
    {
        Color? selectedColor = selected ? ScpPalettes.PanelDarker : null;
        PlayerEntryLabel.FontColorOverride = selectedColor;
        PlayerEntryPinButton.ModulateSelfOverride = selectedColor;
    }
    // Scp added end
