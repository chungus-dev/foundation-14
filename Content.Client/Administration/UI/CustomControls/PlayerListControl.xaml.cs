...
public sealed partial class PlayerListControl : BoxContainer
{
    ...
    public PlayerListControl()
    {
        ...
        // Scp edit - use the SCP stylesheet color instead of the old vanilla-blue hardcoded panel.
    ...
    private void GenerateButton(ListData data, ListContainerButton button)
    {
        ...
        entry.SetSelected(info.SessionId == _selectedPlayer?.SessionId);
    ...
    private void UpdateVisibleEntrySelection()
    {
        foreach (var button in PlayerListContainer.Children.OfType<ListContainerButton>())
        {
            if (button.Children.FirstOrDefault() is not PlayerListEntry entry ||
                button.Data is not PlayerListData { Info: var info })
                continue;
