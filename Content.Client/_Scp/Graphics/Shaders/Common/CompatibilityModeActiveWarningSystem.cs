...
public sealed partial class CompatibilityModeActiveWarningSystem : EntitySystem
{
    ...
    /// </summary>
    [PublicAPI] public bool IsCompatibilityModeEnabled { get; private set; }

    /// <summary>
    /// Будут ли использоваться шейдеры при включенном режиме совместимости?
    /// </summary>
    [PublicAPI] public bool CompabilityUseShaders { get; private set; }

    /// <summary>
    /// Должен ли клиент использовать шейдеры?
    /// </summary>
    [PublicAPI] public bool ShouldUseShaders => !IsCompatibilityModeEnabled || CompabilityUseShaders;
