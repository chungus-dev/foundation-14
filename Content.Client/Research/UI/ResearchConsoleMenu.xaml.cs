...
public sealed partial class ResearchConsoleMenu : FancyWindow
{
    ...
    public Action? OnRediscoverPressed;
    ...
    public ResearchConsoleMenu()
    {
        ...
        RediscoverButton.OnPressed += OnRediscoverButtonPressed;
    }
    ...
    private void UpdateRediscoverButton()
    {
        ...
        RediscoverButton.Disabled = !HasAccess()
                                   || _nextRediscover == null
                                   || _timing.CurTime < _nextRediscover.Value
                                   || !ResearchPointsHelper.IsEnoughPoints(_serverPoints, _rediscoverCost);
    }

    private void OnRediscoverButtonPressed(BaseButton.ButtonEventArgs args)
    {
        RediscoverButton.Disabled = true;
        _nextRediscover = null;

        OnRediscoverPressed?.Invoke();
    }
    ...
    protected override void FrameUpdate(FrameEventArgs args)
    {
        ...
        if (_nextRediscover == null || _nextRediscover.Value > _timing.CurTime)
            return;
